...
const ProfileAddPost = ({userData}) => {
  ...
  <div className={`${styles.margin} ${styles.box}`}>
    ...
    <div className={styles.status_main}>
      ...
      <textarea className={styles.status_textarea} onChange={(e) => handleTextChange(e)} placeholder="Write something.." defaultValue={""}/>
    </div>

    {/* Add youtube link window */}
    {addVideoWindow && <div className={styles.video_window}>
      <input className={styles.video_input} onChange={(e) => setYoutubeUrl(e.target.value)} placeholder="Paste Youtube link"/>
    </div> }
